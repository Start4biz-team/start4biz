            ...
            <div className="footer-info">
                <div className="footer-info-left">
                    <ul className="footer-info-left-list">
                        <li className="footer-info-left-item"><Link to="/about" className="footer-info-left-link">О проекте</Link></li>
                        ...
                        <li className="footer-info-left-item"><Link to="/about" className="footer-info-left-link">Контакты</Link></li>
                    </ul>
                </div>
